...
//======================= read files ======================
	...
	for(auto region:regions){
		if(framework == "tthML") for (int i = 0; i < 5; ++i)
		{
			...
			TH1D *fakePHHW71 = (TH1D*) fakefile->Get("ttbarsys_PHHW71");
		...
		TH1D *ttbarPHHW71 = (TH1D*) ttbarfile->Get("ttbarsys_PHHW71");
